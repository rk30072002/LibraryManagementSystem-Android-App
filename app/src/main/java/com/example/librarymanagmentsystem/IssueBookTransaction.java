...
public class IssueBookTransaction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_issue_book_transaction);
    ...
    private void logOut() {
        ...
        Intent intent = new Intent(IssueBookTransaction.this, LoginActivity.class);
